...
target_fund = ['汇添富中证主要消费ETF', '易方达沪深300医药ETF', '华泰柏瑞沪深300ETF','中欧医疗健康混合A', '易方达蓝筹精选',
...
cols = ['汇添富中证主要消费ETF','国泰纳斯达克100ETF', '易方达安心回馈混合', '易方达裕丰回报债券', '我的组合', '华泰柏瑞沪深300ETF', '招商产业债券A']
